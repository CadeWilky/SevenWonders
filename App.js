...
const image2 = require('./images/taj.png');
const image3 = require('./images/redeemer.png');
const image4 = require('./images/petra.png');
const image5 = require('./images/machu.png');
const image6 = require('./images/colosseum.png');
const image7 = require('./images/chichen.png');




const timeline = [
  { title: 'The Great Wall of China', image: image1 },
  { title: 'Taj Mahal', image: image2 },
  { title: 'The Redeemer', image:  image3 },
  { title: 'Petra', image: image4 },
  { title: 'Machu Picchu', image: image5 },
  { title: 'Colosseum', image: image6 },
  { title: 'Chichen Itza', image: image7 },
